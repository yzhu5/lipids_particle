...
int main(int argc, char **argv)
{
	...
	*/
	...
	if(nNanoparticles>0)
	{
		int cindex=nBEADCONST*(SURFB+NANOTYPE*System.readNTypes());
		int cindexMirror=nBEADCONST*(NANOTYPE+SURFB*System.readNTypes());
	...
	if(nNanoparticles>0)
	{
		int cindex=nBEADCONST*(SURFA+NANOTYPE*System.readNTypes());
		int cindexMirror=nBEADCONST*(NANOTYPE+SURFA*System.readNTypes());
