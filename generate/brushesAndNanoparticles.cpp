...
int main(int argc, char **argv)
{
	...
	{
		//14, brush + NP
		cout << "Usage: " << argv[0] << " name seed nBrushes arealDensity UminBrushNP UmaxBrushNP nNanoparticles nanoRadius UminBrushBrush UmaxBrushBrush nMonomers bondLength temp" << endl;
		return 0;
	}
	char *name=argv[1];
