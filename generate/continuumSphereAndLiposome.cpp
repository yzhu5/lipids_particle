 /*  just a bilayer in various geometries.
...
int main(int argc, char **argv)
{
	if(argc!=12)
	{
		...
		cout << "nanoRadius nanoHeadUmin nanoHeadUmax sigma nNanoInside nNanoOutside dAngle" << endl;
	...
	//boost::vector<T>
	cmdArg >> seed >> nLipids >> lipidArealDensity >> nanoRadius >> nanoHeadUmin >> nanoHeadUmax >> sigma >> nNanoInside >> nNanoOutside >> dAngle;
