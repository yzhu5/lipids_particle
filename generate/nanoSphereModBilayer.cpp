/**
 * \brief Creates a 2 component bilayer membrane with nanoparticles.
 * Nanoparticle chain placement creates a shadow of lipids of other type.
 */
...
int main(int argc, char **argv)
{
	if(argc!=13)
	{
		...
		cout << "Usage: " << argv[0] << " name seed anchorHeadUmin nLipids lipidArealDensity ";
		cout << "nanoRadius nanoHeadUmin nNanoparticles nanoNanoUmin nanoHead2Umin tailTail2Umin tailMaskR\n";
		return 0;
	}
