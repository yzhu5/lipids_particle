/**
 * \brief Simple implicit molecular dynamic system. Just a brush in various geometries.
...
int main(int argc, char **argv)
{
	...
	{
		//12, brush
		cout << "Usage: " << argv[0] << " name seed nBrushes arealDensity UminBrushNP UmaxBrushNP UminBrushBrush UmaxBrushBrush nMonomers bondLength temp" << endl;
		return 0;
	}
	char *name=argv[1];
	...
	double arealDensity, UminBrushNP, UmaxBrushNP, UminBrushBrush,UmaxBrushBrush,bondLength,temp;
	
	cmdArg >> seed >> nBrushes >> arealDensity >> UminBrushNP >> UmaxBrushNP >> UminBrushBrush >> UmaxBrushBrush >> nMonomers >> bondLength >> temp;
